...
BASE_DIR = Path("datasets/crossfade_switchlingua_seame")
INPUT_MIXED_JSON = BASE_DIR / "crossfade_switchlingua_seame_mixed_language.json"
OUTPUT_MIXED_JSON = BASE_DIR / "crossfade_switchlingua_seame_mixed_language_cleaned.json"
OUTPUT_STATS_JSON = BASE_DIR / "crossfade_switchlingua_seame_mixed_language_cleaned_stats.json"
