...
INPUT_SEGMENT_JSON = "datasets/hinglish/whisper_segment_hinglish.json"
INPUT_SWITCH_JSON = "datasets/hinglish/whisper_language_switch_hinglish.json"

OUT_EN = "datasets/hinglish/hinglish_en_language.json"
OUT_HI = "datasets/hinglish/hinglish_hi_language.json"
OUT_MIXED = "datasets/hinglish/hinglish_mixed_language.json"
OUT_NON_EN_HI = "datasets/hinglish/hinglish_non_en_hi_language.json"

BASE_DIR = "datasets/hinglish"
ALLOWED_LANGS = {"hi", "en"}


def normalize_path(path):
    """Convert absolute path to relative datasets/hinglish/..."""
    path = path.replace("\\", "/")
