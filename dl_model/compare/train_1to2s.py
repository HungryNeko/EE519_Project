...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Compare trainer with random 1-2s half-duration training augmentation; "
    ...
    parser.add_argument("--checkpoint-dir", default="dl_model/compare/output/checkpoints_manifest_1to2s")
    parser.add_argument("--summary-csv", default="dl_model/compare/output/summary_manifest_runs_1to2s.csv")
    parser.add_argument("--summary-agg-csv", default="dl_model/compare/output/summary_manifest_aggregate_1to2s.csv")
    parser.add_argument("--test-duration-csv", default="dl_model/compare/output/summary_manifest_test_duration_runs_1to2s.csv")
    parser.add_argument(
